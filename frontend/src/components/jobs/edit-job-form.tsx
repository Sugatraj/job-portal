...
import { Save, Briefcase, Building, MapPin, DollarSign, Calendar, Users, Target, Loader2 } from "lucide-react";
    ...
    const loadJob = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          companyLocation: jobData.companyLocation || "Headquarters",
          ...
          languages: jobData.languages || [{ language: "English", proficiency: "fluent" }],
